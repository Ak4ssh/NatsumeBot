...
from Suzune.utils import (TheVenomXDbin, get_channeplayCB,
                              seconds_to_min)
from Suzune.utils.database import (get_cmode, is_active_chat,
                                       is_music_playing)
from Suzune.utils.decorators.language import language, languageCB
from Suzune.utils.inline import queue_back_markup, queue_markup
