...
from Suzunex import Telegram, YouTube, app
from Suzunex.misc import SUDOERS, _boot_
from Suzunex.plugins.Robot.playlist import del_plist_msg
from Suzunex.plugins.Robot.sudoers import sudoers_list
from Suzunex.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from Suzunex.utils.decorators.language import LanguageStart
from Suzunex.utils.formatters import get_readable_time
from Suzunex.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/suzune_support) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• sᴜᴩᴩᴏʀᴛ •", url="https://t.me/suzune_support"
                        ),
                    ],
                ]
            )
