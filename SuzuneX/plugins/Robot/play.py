...
from Suzunex import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from Suzunex.core.call import TheVenomXD
from Suzunex.utils import seconds_to_min, time_to_seconds
from Suzunex.utils.channelplay import get_channeplayCB
from Suzunex.utils.database import is_video_allowed
from Suzunex.utils.decorators.language import languageCB
from Suzunex.utils.decorators.play import PlayWrapper
from Suzunex.utils.formatters import formats
from Suzunex.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from Suzunex.utils.database import is_served_user
from Suzunex.utils.inline.playlist import botplaylist_markup
from Suzunex.utils.logger import play_logs
from Suzunex.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await TheVenomXD.stream_call(url)
...
@app.on_callback_query(
    filters.regex("TheVenomXDymousAdmin") & ~BANNED_USERS
)
async def TheVenomXDymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("TheVenomXDPlaylists") & ~BANNED_USERS
)
@languageCB
