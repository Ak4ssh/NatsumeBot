...
from Suzunex.utils.database import get_authuser_names, get_cmode
from Suzunex.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Suzunex.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await TheVenomXD.stop_stream(message.chat.id)
    except:
        pass
